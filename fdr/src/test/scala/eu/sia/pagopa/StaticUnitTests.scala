...
import eu.sia.pagopa.common.util.{EventUtil, RandomStringUtils, Util}
import eu.sia.pagopa.testutil.{SpecsUtils, TestItems}
...
class StaticUnitTests() extends AnyFlatSpec with should.Matchers {
  ...
  "iuv rendicontati eventhub json" should "ok" in {
    ...
    val rendicontazione = SpecsUtils
    ...
    val iuvRendicontati = EventUtil.createIUVRendicontatiEvent(
