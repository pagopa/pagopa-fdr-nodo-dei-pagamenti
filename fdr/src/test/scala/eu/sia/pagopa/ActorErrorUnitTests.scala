...
class RegisterFdrForValidationTest(testPromise: Promise[Boolean], override val repositories: Repositories, override val actorProps: ActorProps)
  extends RegisterFdrForValidationActorPerRequest(repositories, actorProps) {
