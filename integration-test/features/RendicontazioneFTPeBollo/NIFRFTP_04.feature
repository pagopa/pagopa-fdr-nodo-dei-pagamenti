...
#
#        And checks the value INVALID of the record at column STATO of the table RENDICONTAZIONE retrived by the query rendicontazione on db fdr under macro RendicontazioneFTPeBollo
...
#
#        # BINARY_FILE
#        And verify 0 record for the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#
