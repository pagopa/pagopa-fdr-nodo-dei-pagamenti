...
#        And checks the value None of the record at column FK_SFTP_FILE of the table RENDICONTAZIONE retrived by the query rendicontazione on db fdr under macro RendicontazioneFTPeBollo
#
#        And execution query rendicontazione to get value on the table RENDICONTAZIONE, with the columns FK_BINARY_FILE under macro RendicontazioneFTPeBollo with db name fdr
#        And through the query rendicontazione retrieve param fkBinaryFile at position 0 and save it under the key fkBinaryFile
#        And checks the value $fkBinaryFile of the record at column ID of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#
...
#
#        # BINARY_FILE
#        And checks the value NotNone of the record at column FILE_SIZE of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#        And checks the value NotNone of the record at column FILE_CONTENT of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#        And checks the value None of the record at column FILE_HASH of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#        And checks the value None of the record at column SIGNATURE_TYPE of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#        And checks the value NotNone of the record at column XML_FILE_CONTENT of the table BINARY_FILE retrived by the query binary_file on db fdr under macro RendicontazioneFTPeBollo
#
#
#        # RENDICONTAZIONE_SFTP_SEND_QUEU
#        And verify 0 record for the table RENDICONTAZIONE_SFTP_SEND_QUEUE retrived by the query send_queue on db fdr under macro RendicontazioneFTPeBollo
#
#
#@runnable
