Feature: Syntax checks for nodoInviaFlussoRendicontazione - KO
    ...
    @runnable
    Scenario Outline: Check error for nodoInviaFlussoRendicontazione primitive - TEST4
    ...
    @runnable
    # [SEM_NIFR_10]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione primitive - TEST1
        Given the Create REND scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
    ...
    @runnable
    # [SEM_NIFR_11]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione primitive - TEST2
        Given the Create REND scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
    ...
    @runnable
    # [SEM_NIFR_14]
    Scenario: Check PPT_AUTORIZZAZIONE error for nodoInviaFlussoRendicontazione primitive - TEST5
        Given the Create REND scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            ...
            <identificativoPSP>#psp#</identificativoPSP>
            <identificativoIntermediarioPSP>#psp#</identificativoIntermediarioPSP>
            <identificativoCanale>15376371009_05</identificativoCanale>
            <password>#password#</password>
            <identificativoDominio>#creditor_institution_code#</identificativoDominio>
            <identificativoFlusso>$identificativoFlusso</identificativoFlusso>
            <dataOraFlusso>$timedate</dataOraFlusso>
    ...
    @runnable
    # [SEM_NIFR_15]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione_dataOraFlussoMinore primitive - TEST7
        Given the Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione_dataOraFlussoUguale primitive - TEST6 scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header/>
    ...
    # [SEM_NIFR_17]
    Scenario: Send nodoInviaFlussoRendicontazione primitive - TEST2
        Given the Create REND scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
    ...
    @runnable
    # [SEM_NIFR_17]
    Scenario: Send nodoInviaFlussoRendicontazione_dataOraMaggiore primitive - TEST8
    ...
    #[SEM_NIFR_19]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione_dataOraFlussoUguale primitive - TEST9
        Given the Send nodoInviaFlussoRendicontazione primitive - TEST3 scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header/>
    ...
    @runnable
    #[SEM_NIFR_19]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione_dataOraFlussoMinore primitive - TEST10
        Given the Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione_dataOraFlussoUguale primitive - TEST9 scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header/>
    ...
    @runnable
    # [SEM_NIFR_20]
    Scenario: Check PPT_SEMANTICA error for nodoInviaFlussoRendicontazione primitive - TEST11
        Given the Create REND scenario executed successfully
        And initial XML nodoInviaFlussoRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
