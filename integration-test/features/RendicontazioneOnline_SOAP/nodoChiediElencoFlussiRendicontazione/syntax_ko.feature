...
Feature: Syntax checks for nodoChiediElencoFlussiRendicontazione - KO
    ...
    @runnable
    #[CEFRSIN0]
    Scenario: Check PPT_SINTASSI_EXTRAXSD error on invalid wsdl namespace - TEST1
    ...
    @runnable
    #[CEFRSIN1]
    Scenario: Check PPT_SINTASSI_EXTRAXSD error for nodoChiediElencoFlussiRendicontazione primitive - TEST2
        Given initial XML nodoChiediElencoFlussiRendicontazione
            """
    ...
    @runnable
    #[CEFRSIN3]
    Scenario: Check PPT_SINTASSI_EXTRAXSD error for nodoChiediElencoFlussiRendicontazione primitive - TEST3
        Given initial XML nodoChiediElencoFlussiRendicontazione
            """
    ...
    @runnable
    Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error for nodoChiediElencoFlussiRendicontazione primitive - TEST4
        Given initial XML nodoChiediElencoFlussiRendicontazione
            """
    ...
    @runnable
    Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error for nodoChiediElencoFlussiRendicontazione primitive - TEST5
        Given initial XML nodoChiediElencoFlussiRendicontazione
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header/>
